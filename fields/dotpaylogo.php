...
class JFormFieldDotpayLogo extends JFormField {
	...
	function getInput() {
        ...
        return "<a href='http://www.dotpay.pl' target='_blank'><img src=$src /></a><script type='text/javascript'>jQuery(document).ready(function() {jQuery('#params_dotpay_urlc_info-lbl').parents().css('width', 'auto')});</script>";
	}
}